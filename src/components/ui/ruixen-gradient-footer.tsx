...
// Cores adaptadas para um visual de tecnologia/DevClub (Azul, Roxo, Ciano)
const DEVCLUB_STOPS: Stop[] = [
  { offset: 0, color: "#000000" },
  { offset: 0.2, color: "#0A0A0A" },
  { offset: 0.4, color: "#111827" },
  { offset: 0.6, color: "#1E3A8A" }, // Blue 900
  { offset: 0.8, color: "#3B82F6" }, // Blue 500
  { offset: 0.9, color: "#8B5CF6" }, // Violet 500
  { offset: 1, color: "#D8B4FE00" }, // Transparent
];
...
export function RuixenGradientFooter({
  ...
  return (
    <footer
      className={className}
      style={{ paddingBottom: gradientHeight, position: "relative", ...style }}
    >
